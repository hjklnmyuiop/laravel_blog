...
<div class="result_wrap">
    <form action="{{url('admin/down/'.$field->id)}}" method="post">
...
//                                    alert(data);
            ...
            <tr>
                <th></th>
                <td>
                    <img alt="" id="art_thumb_img" style="max-width: 350px; max-height:100px;" src="/{{$field->thumb}}">
                </td>
            </tr>
            <tr>
                <th>下载地址：</th>
                <td>
                    <textarea name="downurl">{{$field->downurl}}</textarea>
                </td>
            </tr>
            <tr>
                <th>描述：</th>
