...
<div class="menu_box">
	<ul>
		...
		<li>
			<h3><i class="fa fa-fw fa-clipboard"></i>下载管理</h3>
			<ul class="sub_menu">
				<li><a href="{{url('admin/downcategory/create')}}" target="main"><i class="fa fa-fw fa-plus-square"></i>添加下载分类</a></li>
				<li><a href="{{url('admin/downcategory')}}" target="main"><i class="fa fa-fw fa-list-ul"></i>下载分类列表</a></li>
				<li><a href="{{url('admin/down/create')}}" target="main"><i class="fa fa-fw fa-plus-square"></i>添加下载</a></li>
				<li><a href="{{url('admin/down')}}" target="main"><i class="fa fa-fw fa-list-ul"></i>下载列表</a></li>
			</ul>
		</li>
	</ul>
</div>
...
<div class="bottom_box">
	CopyRight © 2015. Powered By <a href="http://www.58keke.cn">http://www.58keke.cn</a>.
</div>
<!--底部 结束-->
